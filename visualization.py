...
def save_figure(figure: plt.Figure, directory: str, filename: str):
    """
    Saves a figure plotted using matplotlib to a specific directory.
    ...
    ------
        ...
        directory: str 
            The directory to save the figure in. If the directory
